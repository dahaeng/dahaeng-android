/**
 * https://github.com/PRNDcompany/ReadMoreTextView/blob/master/readmore-textview/src/main/java/kr/co/prnd/readmore/ReadMoreTextView.kt
 */

package team.dahaeng.android.ui.readmoretextview
...
class ReadMoreTextView @JvmOverloads constructor(
    ...
    private var readMoreColor = ContextCompat.getColor(context, R.color.primary)
